...
(function ($) {
	...
	$.fn.SPCOMServices.SPCascadeDropdowns = function(options) {
		...
		var thisFunction = "SPCOMServices.SPCascadeDropdowns";
	...
	$.fn.SPCOMServices.SPComplexToSimpleDropdown = function(options) {
		...
		if(columnSelect.Obj.html() === null && opt.debug) {errBox("SPCOMServices.SPComplexToSimpleDropdown", "columnName: " + opt.columnName, TXTColumnNotFound); return;	}
	...
	$.fn.SPCOMServices.SPDisplayRelatedInfo = function(options) {
		...
		var relatedListXML;
		var thisFunction = "SPCOMServices.SPDisplayRelatedInfo";
	...
	$.fn.SPCOMServices.SPFilterDropdown = function(options) {
		...
		var thisFunction = "SPCOMServices.SPFilterDropdown";
	...
	$.fn.SPCOMServices.SPLookupAddNew = function(options) {
		...
		var thisFunction = "SPCOMServices.SPLookupAddNew";
	...
	}; // End $.fn.SPCOMServices.SPXmlToJson
...
////// PRIVATE FUNCTIONS ////////
	...
	function showColumn(listXML, columnXML, columnValue, opt) {
		...
		var dispUrl;
		var numDecimals;
		var webUrl = opt.relatedWebURL.length > 0 ? opt.relatedWebURL : $().SPCOMServices.SPGetCurrentSite();

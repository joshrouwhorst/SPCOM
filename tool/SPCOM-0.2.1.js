            ...
            $().SPCOMServices({
                ...
                completefunc: function(xData, status){
                    ...
                    try{
                        ...
                        $("#testQueryResults tbody").html("Invalid XML.");
                        return;
                    }
                    ...
                    html = "<table class='testQueryStats' cellspacing='0px'><tr><td><h3>Item Counts</h3></td><td><span class='label'>Total:</span> " + results.items.length + "</td></tr>";
                    var i = -1; 
                    for (var tag in queryArr){
